...
//config:       default "/tmp/eperd/new/ooq"
//config:       depends on EOOQD
//config:       help
...
#define SUFFIX 		".curr"
#define OOQD_NEW_PREFIX_REL	CONFIG_FEATURE_EOOQD_NEW_PREFIX
#define OOQD_OUT_PREFIX_REL	CONFIG_FEATURE_EOOQD_OUT_DIR
